...
export const afterBeingUnmounted = () => {
    ...
    return (
        <div>
            ...
            {!destroyed && (
                <i>Time left before destruction: {timeLeft} seconds</i>
            )}
            <p>Ut posuere rhoncus feugiat. Maecenas fringilla luctus nisl a euismod. Nam suscipit viverra turpis, eu molestie sapien fermentum id. Integer a laoreet nisi. Proin ornare, neque id condimentum sagittis, massa libero dictum enim, eu semper ipsum dolor sit amet nunc. Sed id auctor odio, sit amet viverra nunc. Proin nec metus at massa pretium tincidunt. In bibendum, risus eu interdum convallis, diam tellus sagittis ante, vel feugiat augue nunc nec purus. Integer et bibendum dolor. Phasellus faucibus a ipsum ut finibus. Sed ullamcorper risus sit amet posuere suscipit.</p>
        </div>
    );
};
